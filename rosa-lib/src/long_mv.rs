...
/*
    ...
    Left: Is_cap, cap_piece, cap_prio -> 11 bits left
    Is Cap: 1
    Is win: 1
...
impl Mv {
    ...
    pub fn castle(&self) -> CastleType {
        CastleType::WK
    }
    pub fn prom_piece(&self) -> i8 {
        0
    }
    pub fn special(&self) -> SpecialMoveFlag {
        SpecialMoveFlag::NULL
    }
